...
<div class="container-fluid">
    ...
    <h4 class="page-title">
        <a href="<?= base_url("admin/city") ?>" class="btn btn-warning">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <form action="<?= base_url("admin/city/add") ?>" method="POST">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="state_name" class="form-control input-solid" required>
                            <?php foreach($stateData as $c): ?>
                        ...
                        <div class="form-group"> <!--has-success-->
                            ...
                            <input type="number" name="sort_order" class="form-control input-solid" required>
                        </div>
                        <div class="form-group"> <!--has-success-->
                            <label>City Name</label>
                            <input type="text" name="name" class="form-control input-solid" required>
                            <strong>Note: add more city after comma</strong>
                        </div>
                        <div class="form-group">
