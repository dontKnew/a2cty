    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="<?= base_url("admin/category/add") ?>" class="btn btn-info">
                        ...
                        <table class="table table-head-bg-primary table-striped table-hover text-center">
                            ...
                            <?php foreach ($data as $value): ?>
                                <tr>
                                    ...
                                    <td>
                                        <img style="object-fit:cover" src="<?=base_url()?>/frontend/images/category/<?= esc($value['thumbnail_image']) ?>" alt="<?=$value['name']?>" height="100" width="150" />
                                    </td>
                                    <td>
                                        <a href="<?= base_url()."/admin/category/delete/".$value['id'] ?>"
                                           class="btn btn-sm btn btn-rounded btn-warning my-1">
                                            <i class="la la-trash"></i> Delete
                                        </a>
                                        <a href="<?= base_url()."/admin/category/".$value['id'] ?>"
