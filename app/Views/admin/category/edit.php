    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <form method="POST"  action="<?php echo base_url("admin/category/".$data['id']); ?>" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12">
                                ...
                                <img style="object-fit:cover" src="<?=base_url()?>/frontend/images/category/<?= esc($data['thumbnail_image']) ?>" alt="<?=$data['name']?>" height="100" width="150" />
                            </div>
                            <div class="form-group col-12">
