    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <form method="POST"  action="<?php echo base_url("admin/blog/".$data['id']); ?>" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <input type="text" name="blog_title" value="<?=$data['blog_title']?>" class="form-control input-solid" required>
                            </div>
                            <div class="form-group col-6">
                                <label>Category Name</label>
                                <input type="text" name="category" value="<?=$data['category']?>" class="form-control input-solid" required>
                            </div>
                            <div class="form-group col-6">
                            ...
                            <div class="form-group col-12">
                                ...
                                <img style="object-fit:cover" src="<?=base_url()?>/frontend/images/blog/<?= esc($data['thumbnail_image']) ?>"  height="100" width="150" />
                            </div>
                            <div class="form-group col-12">
