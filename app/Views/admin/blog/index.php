    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="<?= base_url("admin/blog/add") ?>" class="btn btn-info">
                    <i class="la la-plus-circle"></i> Add  Blog
                </a>
            </div>
                        ...
                        <table class="table table-head-bg-primary table-striped table-hover text-center">
                            ...
                            <?php foreach ($data as $value): ?>
                                <tr>
                                    ...
                                    <td>
                                        <img style="object-fit:cover" src="<?=base_url()?>/frontend/images/blog/<?= esc($value['thumbnail_image']) ?>"  height="100" width="150" />
                                    </td>
                                    <td>
                                        <a href="<?= base_url()."/admin/blog/delete/".$value['id'] ?>"
                                           class="btn btn-sm btn btn-rounded btn-warning my-1">
                                            <i class="la la-trash"></i> Delete
                                        </a>
                                        <a href="<?= base_url()."/admin/blog/".$value['id'] ?>"
