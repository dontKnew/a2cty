        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Add  Escort</div>
                </div>
                <form method="POST"  action="<?php echo base_url("admin/escort/add"); ?>" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <input type="text" name="escort_title" value="<?=old('escort_title')?>" class="form-control input-solid" required>
                            </div>
                            <div class="form-group col-6">
